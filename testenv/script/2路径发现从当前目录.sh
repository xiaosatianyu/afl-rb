...
rm -r '/home/xiaosatianyu/Desktop/driller/路径发现速度.png' 
...
set output '/home/xiaosatianyu/Desktop/driller/路径发现速度.png' 
...
plot './plot_data_shelfish' using 1:4 with lines title 'AFL-shelfish'   linewidth 2 , \\
     './plot_data_yyy' using 1:4 with lines title 'AFL-yyy'   linewidth 8 #linetype 4
