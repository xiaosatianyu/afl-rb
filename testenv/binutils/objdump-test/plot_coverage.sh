...
plot '/tmp/out-fairfuzz-objdump/master/plot_data'  using 1:4 with lines title 'farifuzz'    linewidth 4 linetype 8,\\
     '/tmp/out-para-objdump/master/plot_data'  using 1:4 with lines title 'para'    linewidth 4 linetype 6 ,\\
